...
const DonationForm = () => {
  ...
  if (createdReceipt) {
    return (
      <div className="max-w-2xl mx-auto saas-card p-8 rounded-xl shadow-lg border border-slate-200/50 dark:border-slate-700/50 text-center">
  ...
  return (
    <div className="max-w-4xl mx-auto saas-card rounded-xl shadow-sm border border-slate-200/50 dark:border-slate-700/50 overflow-hidden">
      <div className="px-6 py-4 border-b border-slate-200/50 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-900/50">
      ...
      <form onSubmit={handleSubmit((data) => onSubmit(data, false))} className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input 
              ...
              className={`w-full px-3 py-2 border rounded-md dark:bg-slate-700 dark:text-white focus:ring-primary-500 focus:border-blue-500 ${errors.donorName ? 'border-red-500' : 'border-slate-300 dark:border-slate-600'}`} 
            />
          ...
          <div>
            ...
            <input 
              ...
              className={`w-full px-3 py-2 border rounded-md dark:bg-slate-700 dark:text-white focus:ring-primary-500 focus:border-blue-500 ${errors.mobile ? 'border-red-500' : 'border-slate-300 dark:border-slate-600'}`} 
            />
          ...
          <div>
            ...
            <input 
              ...
              className={`w-full px-3 py-2 border rounded-md dark:bg-slate-700 dark:text-white focus:ring-primary-500 focus:border-blue-500 ${errors.amount ? 'border-red-500' : 'border-slate-300 dark:border-slate-600'}`} 
            />
          ...
          <div>
            ...
            <input 
              ...
              className={`w-full px-3 py-2 border rounded-md dark:bg-slate-700 dark:text-white focus:ring-primary-500 focus:border-blue-500 ${errors.doorNumber ? 'border-red-500' : 'border-slate-300 dark:border-slate-600'}`} 
            />
          ...
          {paymentMode === 'UPI' && (
            <div className="md:col-span-2 p-4 bg-transparent rounded-lg border border-slate-200/50 dark:border-slate-700/50 mt-4">
              {amount > 0 && settings?.upiId ? (
                <div className="mb-6 flex flex-col sm:flex-row items-center gap-6 p-4 saas-card border border-slate-200/50 dark:border-slate-700/50 rounded-lg shadow-sm">
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <div className="flex gap-4 justify-center">
                    <button
                      type="button"
                      onClick={stopCamera}
                      className="px-6 py-2 border border-slate-300 dark:border-slate-600 text-sm font-medium rounded-lg text-slate-700 dark:text-slate-200 saas-card hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
                    >
                      Cancel
                    </button>
                    <button
              ...
              {upiScreenshot && !showCamera && (
                <div className="mt-4 p-4 border border-green-200 bg-green-50 dark:bg-green-900/30 dark:border-green-800 rounded-lg">
                  ...
                  <div className="mt-3 flex justify-center saas-card p-2 rounded border border-green-100 dark:border-green-800 max-h-48 overflow-hidden">
        ...
        <div className="mt-6 flex flex-col md:flex-row justify-end items-center gap-6 pt-6 border-t border-slate-200/50 dark:border-slate-700/50">
          
          <button
            type="submit"
            disabled={loading}
            className="w-full md:w-auto inline-flex justify-center py-3 px-8 border border-transparent shadow-sm text-sm font-bold rounded-md text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 transition-colors"
          >
